...
> Refatorar o frontend Angular da Todo List de um *god component* (`any`, estilos inline, dados "fake", URL errada) para uma arquitetura moderna (serviço + componentes + signals), consumindo `/api/tarefas` e responsiva, **sem alterar a funcionalidade**. · Estado: em progresso (Fase 10) · Fecha: 2026-07-05 · Autor: Pedro Vargas
